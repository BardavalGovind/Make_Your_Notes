      ...
      <div className="flex h-full w-full flex-col gap-10 px-20 lg:flex-row lg:justify-between">
        ...
        <div className="">
          <h2 className="relative mb-3 text-2xl font-black
           before:absolute before:top-[30px] before:h-[3px] before:w-[50px] before:bg-blue-500">
            Contact Info
          </h2>
          <ul className="text-gray-600">
            <li className="mb-1">
              <Link to="/about">+91 91822 74217</Link>
            </li>
            <li className="mb-1">
              <Link to="/faq">+91 91822 74217</Link>
            </li>
            <li className="mb-1">
              <Link to="/faq">bardavalgovind2005@gmail.com</Link>
            </li>
          </ul>
        </div>
      </div>
